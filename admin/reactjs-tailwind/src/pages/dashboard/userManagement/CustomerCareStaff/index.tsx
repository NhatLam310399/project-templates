...
const CustomerCareStaffsPage: React.FC<RouteComponentProps> = ({
  location,
}) => {
  ...
  return (
    <div>
      <div className="flex flex-wrap items-center justify-between gap-1 mb-3">
        <Dialog ButtonMenu={<AddButton>Thêm nhân viên chăm sóc </AddButton>} />
...
export default withRouter(CustomerCareStaffsPage);
