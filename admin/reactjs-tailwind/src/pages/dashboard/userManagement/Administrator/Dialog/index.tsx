...
// haven't design
const AdminDialog: React.FC<IAdminDialogProps> = props => {
  ...
  const handleSubmit = () => {
    const userInput: IUserInput = {
      ...
      permission: permissionSelected?.type || "ADMIN",
