...
const NotFound: React.FC = () => {
  return (
    <div className="text-black h-screen w-full py-5 px-2 laptop:px-0 text-bold flex flex-col items-center justify-center">
      <div className="mb-2">
        <SVG name="not-found/404" width={750} height={500} />
      </div>
      <h2 className="text-2xl laptop:text-4xl text-center font-bold mb-2 text-primary">
        Có lỗi xảy ra với hệ thống !
      </h2>
      <p className="mb-2 text-primary text-xl laptop:text-xxl text-center">
      ...
      <div>
        <Button
          ...
          innerClassName="laptop:px-15 px-8 text-xl normal-case"
          to={PATH.HOME}
        >
          Về trang chủ
        </Button>
