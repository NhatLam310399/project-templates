      ...
      <div className={className}>
        <label htmlFor="upload-photo">
          <div className="rounded-full cursor-pointer relative bg-white shadow-sm">
            <img src={displayImage} className="rounded-full w-10 h-10" />
            <div className="absolute -right-0.5 -bottom-0.5 bg-white rounded-full w-3.5 h-3.5 flex justify-center items-center shadow-sm">
              {/* <UploadFileIcon /> */}
            </div>
          </div>
        </label>
