...
import { searchAllArticleSuccess } from "redux/actions/help";

export function* searchAllArticle(payload: any) {
  ...
  if (result) {
    yield put(searchAllArticleSuccess(result.getAllArticle.results));
  }
}
